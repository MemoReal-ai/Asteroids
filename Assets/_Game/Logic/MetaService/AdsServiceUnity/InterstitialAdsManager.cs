...
{
    public class InterstitialAdsManager : IInitializable, IInterstitialAds, IUnityAdsShowListener, IUnityAdsLoadListener
    {
        ...
        public InterstitialAdsManager(IAdsService adsService)
        {
